...
const uniq = function(arr, callback){
  for(let i = 0; i < arr.length; i++){
...
each(names,(item, index) => {
  console.log(`The item at index ${names.indexOf(item)} is ${names[index]}.`)} );
...
const addNUMBER = addingFactory(22);
...
const getUserById = function(arr, id, callback){
