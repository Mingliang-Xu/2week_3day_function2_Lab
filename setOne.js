...
const myFunc = (firstName, lastName) => console.log(`The first parameter is ${firstName}. The second parameter is ${lastName}`);
myFunc('Oliver', 'Xu');
...
const pricesPlusTax = function(arr, callback){
    for(let i = 0; i < arr.length; i++){
...
const multiplyingFactory = function(num1){
